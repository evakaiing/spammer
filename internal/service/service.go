...
// GetUser имитирует запрос в «базу» для получения пользователя по email
...
// GetMessages имитирует запрос в хранилище сообщений
...
var antispamConcurrentRequests int32
...
// HasSpam имитирует обращение к антиспам-сервису
